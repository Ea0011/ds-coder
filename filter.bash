...
python3 preprocessing/filtering.py --dataset_name="wlm_instruct" --regex_filters_path="./preprocessing/regex_patterns/python_ds.json" --tag=python --tag_col=lang --save_name="python-wlm-instruct.parquet"